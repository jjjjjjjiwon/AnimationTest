...
public class SocketManager
{
    ...
    public PlayerSkillData GetCurrentSkill()
    {
        ...
        return activeSocket?.GetCurrentSkill(); // 이제 ComboSocket이 PlayerSkillData를 줌
    }
    /// <summary>
    /// 현재 입력키
    /// </summary>
    ...
    {
        ComboSocket activeSocket = GetActiveSocket();
        // 리스트 타입도 PlayerSkillData로 변경
        return activeSocket?.GetComboHistory() ?? new List<PlayerSkillData>();
    }
...
// ========================================
    ...
    /// <summary>
    /// ID(string)를 통해 실제 PlayerSkillData를 가져옵니다.
    /// UI(SocketSlotUI 등)에서 아이콘이나 이름을 띄울 때 사용합니다.
    /// </summary>
    public PlayerSkillData GetSkillData(string skillID)
    {
